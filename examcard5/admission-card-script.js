        ...
        try {
            ...
            jsonData.forEach(row => {
                ...
                const subject = {
                    ...
                    seatNumber: String(row['座位號'] || row['Seat Number'] || '').trim(), // v4.2: 修復座位號
                    examDate: examDate,
...
function downloadExcelTemplate() {
    ...
    XLSX.writeFile(workbook, '準考證與貼紙資料模板_v4.1.xlsx');
}
...
function generateCardHTML(candidate, cardIndex) {
    ...
    const monthNames_zh = ['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'];
    ...
    function generateSubjectRows() {
        return candidate.subjects.map(subject => `
            <tr>
                ...
                <td class="center-align">${subject.seatNumber || ''}</td>
            ...
            <table class="exam-table">
                <thead>
                    <tr>
                        ...
                        <th class="col-seat">
                            <div class="th-ch">座位號</div>
                            <div class="th-en">Seat No.</div>
                        </th>
                        <th class="col-date">
